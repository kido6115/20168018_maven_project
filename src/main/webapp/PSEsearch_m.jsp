			...
			$("#wrapper").toggleClass("toggled");
						...
						<form name="form1" class="fontstyle" method="post">
								...
								<tr>
									...
									<td><p align="left">
											請假開始時間&nbsp;: &nbsp;<input type="date" name="sdate"
												value="<%=request.getAttribute("sdate")%>">&nbsp;&nbsp;
											<br> <br> 請假結束時間&nbsp;: &nbsp;<input type="date"
												name="edate" value="<%=request.getAttribute("edate")%>">
											<br> <br>員工編號&nbsp; :&nbsp;
											<%
												if(request.getAttribute("Eid")==null){
											%>
											<input type="text" name="Eid" style="width: 10%" id="Eid"
												value="">
											<%
												} else {
											%>
											...
											%>
											<input type="text" name="Name" style="width: 20%" id="Name"
												value="">
											<%
												} else {
											%>
							...
							<button class="btn btn-warning" id="excel"
								type="submit" onClick="return switchAndSubmit2()">	匯出excel檔</button>
						...
						<script language="javascript">
							function switchAndSubmit() {
								...
								formObj.action = "PSEsearchServlet";
								formObj.submit();
								return false;
							}
